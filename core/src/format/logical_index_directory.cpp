...
Status LogicalIndexDirectoryReader::open(Slice framed,
                                         LogicalIndexDirectoryReader* out) {
  if (out == nullptr) {
...
Status LogicalIndexDirectoryReader::find(uint64_t index_id, std::string_view suffix,
